...
import java.util.GregorianCalendar;     
 ...
 public class Type1Tester
 {
    ...
    public Type1Tester(){
        ...
        System.out.println("------------------------------------------------------------------------------------------------------------------------");
        question[5]=("We take things for granted; they know that life CANNOT be taken for granted. We live on what our parents build for us; they build a future for THEMSELVES. We live the gift of privileges; they privilege the GIFT of LIFE.");  
        question[9]=("If at times you feel so depressed and inferior, it is a proof of the fact that you are a superior being, for fools and imbeciles cannot feel the way you do. So shed off all feelings of inferiority.");
        question[8]=("Success doesn't mean the absence of failures; it means the attainment of ultimate objectives. It means winning the war, not every battle.");
        question[7]=("We make a living by what we get. We make a LIFE by what we give. Give a man a fish, you feed him for a day. Teach him how to fish, you feed him for a LIFETIME.");
        ...
        question[2]=("In the process of gaining our rightful place we must not be guilty of wrongful deeds. Let us not seek to satisfy our thirst for success by drinking from the cup of bitterness and hatred.");
        question[0]=("People suffer when they do not go to God and don't look to Him for help. That's why there's so much pain and suffering in the world.");
        question[3]=("Some people come into our lives and quickly go. Some stay for a while and leave footprints on our hearts. And we are never, ever the same.");
        question[1]=("Manners are like the zero in arithmetic. In themselves they don't have much value, but when added on, they increase the value of everything.");
        question[6]=("In stead of always harping on a man's faults, tell him of his virtues. Try to pull him out of his rut of bad habits. Hold up to him his better self, his real self that can dare and do and win out.");
	...
	System.out.println("\nWhen you are ready, press any key and start typing below.");
            try{
                String str=inpt.readLine();
            }
            catch(IOException e){}
