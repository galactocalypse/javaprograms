...
public class Dermot extends Applet implements Runnable{
Thread t;
boolean rng;
...
g.setFont(new Font("Xenotron",Font.BOLD,80));
FontMetrics m=g.getFontMetrics(new Font("Xenotron",Font.BOLD,80));
for(int i=0;i<15;i++){
...
g.setPaint(text);
g.drawString("ADARSH",(getWidth()-m.stringWidth("ADARSH"))/2,(getHeight()/2));
