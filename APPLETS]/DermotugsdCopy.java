...
import java.applet.*;
public class DermotugsdCopy extends Applet {
public void init(){
}
...
g.setPaint(tp);
g.setFont(new Font("Xenotron",Font.BOLD,500));
g.drawString("A",10,400);
...
if(xy%2==0||xy%3==0)
draw3DR(g,i,j,size,size,dpt,lim,1-flag);
}
}
}
...
int lim=l;
for(int i=0;i<dpt;i++){
if(flag==1)g.setColor(new Color(i*lim/dpt,50,0));    
else g.setColor(new Color(255-(i*lim/dpt),50,0));    
