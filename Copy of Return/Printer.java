...
String name,invnum,date;
String[] qty,ptc,rts,prs,amts;
NumberToWords ntw;
public Printer(){
new JFrame("Frame Demo");
setDefaultCloseOperation(EXIT_ON_CLOSE);
setBackground(Color.white);
setSize(480,660);
name="jgj hljk hejh ushf hoiy ihdfi yiu uyuy uyuyuy uyuy  uyu u hkhe jhjhejh";
invnum="jgjdhf";
date="26-05-2008";
qty=ptc=amts=rts=prs=new String[10];
for(int i=0;i<10;i++){
qty[i]="100";
rts[i]="10";
prs[i]="10";
amts[i]="10000";
ptc[i]="Lamba chaura description hoga shayad.... ...pata nahi.. ...dekhte hain...";
...
g.drawString("DATE",347,70);
g.drawString("ORDER No. & DATE",232,90);
g.drawString("CHALLAN No.",347,90);
g.drawString("& DATE",347,100);
...
pt(r,g,name.split(" "),new Font("Arial",Font.PLAIN,12));
...
pt(r,g,invnum.split(" "),new Font("Arial",Font.PLAIN,12));

//g.drawRect(380,60,75,20);
cx=380;
cy=60;
r=new Rectangle(cx,cy,75,20);
pt(r,g,date.split(" "),new Font("Arial",Font.PLAIN,10));

//g.drawRect(306,82,36,14);
cx=306;
cy=82;
r=new Rectangle(cx,cy,36,14);
pt(r,g,date.split(" "),new Font("Arial",Font.PLAIN,12));
...
pt(r,g,(ptc[i]).split(" "),new Font("Arial",Font.PLAIN,12));
r=new Rectangle(cx-60,cy,20,ht);
pt(r,g,("100").split(" "),new Font("Arial",Font.PLAIN,12));
r=new Rectangle(cx+262,cy+4,28,ht-6);
g.drawRect((int)r.getX(),(int)r.getY(),(int)r.getWidth(),(int)r.getHeight());
pt(r,g,("1054654").split(" "),new Font("Arial",Font.PLAIN,12));
r=new Rectangle(cx+295,cy+4,15,ht-6);
g.drawRect((int)r.getX(),(int)r.getY(),(int)r.getWidth(),(int)r.getHeight());
pt(r,g,("11").split(" "),new Font("Arial",Font.PLAIN,12));
