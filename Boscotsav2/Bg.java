...
public class Bg extends Applet  implements Runnable,ActionListener,MouseListener,MouseMotionListener{
  Color fc1=Color.gray;Color fc2=Color.gray;
int timeLimit=7200;
    Anim anim=new Anim();
    int score=0;
    Image myImg;
    ...
    public void init(){
        ...
        setIgnoreRepaint(true);
         ...
         myImg=createImage(900,600);
         anim.setBounds(230,20,432,60);

         
         try{
        for(int i=0;i<levels;i++){
            rec[i]=new Record(getImage(getCodeBase(),"images//"+i+".jpg"),(i+1));
        }
    }
    catch(Exception e){
    ...
    running=false;
        ...
        //if(new Rectangle2D.Float(890,540,10,10).contains(pt))
        {showHint1=!showHint1;}
